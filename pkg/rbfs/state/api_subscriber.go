...
/*
SubscriberApiService Get access line information.
...
/*
SubscriberApiService Get adjusted accounting counter values.
Computes the adjusted accounting counter values for a given subscriber. This endpoint has been deprecated and will be removed in a future release. Please use &#x60;GET /subscribers/{subscriber_id}/adjusted-accounting&#x60; instead.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param subscriberId The subscriber ID.
@return SubscriberAdjustedAccounting
*/
func (a *SubscriberApiService) SubscribersSubscriberIdGetAdjustedAccountingGet(ctx context.Context, subscriberId int32) (SubscriberAdjustedAccounting, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/subscribers/{subscriber_id}/getAdjustedAccounting"
	localVarPath = strings.Replace(localVarPath, "{"+"subscriber_id"+"}", fmt.Sprintf("%v", subscriberId), -1)
